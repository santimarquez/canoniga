...
class FDALabelsExtractor(DataSourceExtractor):
    source_name = "fda_labels"
    ...
    def fetch_docs(
        ...
        *,
        ...
        docs = sync_module.fetch_fda_labels(query=effective_query, max_results=max_results, from_file=from_file)
