...
class ArrayExpressExtractor(DataSourceExtractor):
    source_name = "arrayexpress"
    ...
    def fetch_docs(
        ...
        *,
        ...
        docs = sync_module.fetch_arrayexpress(query=effective_query, max_results=max_results, from_file=from_file)
