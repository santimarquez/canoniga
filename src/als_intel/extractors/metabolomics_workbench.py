...
class MetabolomicsWorkbenchExtractor(DataSourceExtractor):
    source_name = "metabolomics_workbench"
    ...
    def fetch_docs(
        ...
        *,
        ...
        docs = sync_module.fetch_metabolomics_workbench(query=effective_query, max_results=max_results, from_file=from_file)
